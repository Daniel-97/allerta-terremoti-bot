...
<text x="24" y="44" font-family="Arial, sans-serif" font-size="24" font-weight="bold" fill="url(#wave)" letter-spacing="0.5">${location}</text>
<text x="24" y="76" font-family="Arial, sans-serif" font-size="16" fill="#6b6b6b">
...
<text x="530" y="58" font-family="Arial, sans-serif" font-size="46" font-weight="bold" fill="url(#wave)" text-anchor="middle">${magnitude}</text>
<text x="530" y="86" font-family="Arial, sans-serif" font-size="13" fill="#8a8a8a" text-anchor="middle" letter-spacing="0.5">MAGNITUDO</text>
</svg>`;
}
